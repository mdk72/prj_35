...
'''
#파일 경로입니다.
asset_tym_file_path = "C:/Users/mdk72/Desktop/StockBot/prj_35/" + BOT_NAME + ".json"
'''
################################################
'''
data_file_path = "C:/Users/mdk72/Desktop/StockBot/prj_37/KrStock_" + BOT_NAME + ".json"
...
#영상엔 없지만 리밸런싱이 가능할때만 내게 메시지를 보내자!
#if Is_Rebalance_Go == True:
#    telegram_alert.SendMessage(data_str)
